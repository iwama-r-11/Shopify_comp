    ...
    _createClass(ProductReviews, [{
      ...
      value: function _onReviewsLoad() {
        ...
        var sprSummaryActions = this.element.querySelector('.spr-summary-actions'),
            ...
            previousSprPaginationPrev = sprSummaryActions.querySelector('.spr-pagination-prev'),
            sprPaginationNext = this.element.querySelector('.spr-pagination .spr-pagination-next'),
            sprPaginationPrev = this.element.querySelector('.spr-pagination .spr-pagination-prev');

        if (previousSprPaginationNext) {
          previousSprPaginationNext.remove();
        }
        if (previousSprPaginationPrev) {
          previousSprPaginationPrev.remove();
        }

        if (sprPaginationNext) {
          sprSummaryActions.insertBefore(sprPaginationNext, sprSummaryActions.querySelector('.spr-summary-actions-newreview'));
        }
        if (sprPaginationPrev) {
          sprSummaryActions.insertBefore(sprPaginationPrev, sprSummaryActions.querySelector('.spr-summary-actions-newreview'));
        }
